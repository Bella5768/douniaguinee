    ...
    SECTION_DEFS = {
        ...
        'rapport': {
            ...
            'fields': [
                ...
                {'name': 'rapport_lien', 'label': 'Lien de téléchargement du rapport', 'is_textarea': False, 'is_url': True, 'is_image': False, 'help_text': 'URL vers le PDF (Google Drive, Dropbox, etc.)'},
